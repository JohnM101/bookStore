    ...
    const getSortedProducts = () => {
        switch (sortOption) {
            case 'price-low-to-high':
                return [...desktopData].sort((a, b) => a.price - b.price);
            case 'price-high-to-low':
                return [...desktopData].sort((a, b) => b.price - a.price);
            default:
                return desktopData; // No sorting
        }
    };
            ...
            <div className="product-section">
                ...
                <div className="product-grid">
                    {getSortedProducts().length > 0 ? (
                        ...
                        <p className="no-products">No desktop products available at the moment.</p>
                    )}
                </div>
