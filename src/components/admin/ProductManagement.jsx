...
const ProductManagement = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (!formData.name || !formData.description || !formData.category || !formData.subcategory || !formData.price || !formData.countInStock || !formData.image) {
    ...
    <div className="admin-container">
      <div className="product-form-container">
        ...
        <form onSubmit={handleSubmit} className="product-form">
          ...
          {imagePreview && <img src={imagePreview} alt="Preview" style={{height:80, marginRight:10}}/>}

          <input type="text" name="name" value={formData.name} onChange={handleInputChange} placeholder="Product Name" required/>
          <textarea name="description" value={formData.description} onChange={handleInputChange} placeholder="Product Description" required/>
          ...
          <input type="number" name="countInStock" value={formData.countInStock} onChange={handleInputChange} placeholder="Stock" required/>
